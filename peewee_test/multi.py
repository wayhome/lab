...
if __name__ == '__main__':
    print MultiMySQLDatabase.__mro__
    DATABASE = {'master': 'mysql://zhihu:zhihu@zhihu.dev/zhihu',
                'slaves': ['mysql://zhihu:zhihu@zhihu.dev/zhihu']}
    ...
    member = Member.get(id=1)
    member.fullname = 'test'
    member.save()
    print member.fullname
    member.fullname = u'周源'
    member.save()
    print member.fullname
